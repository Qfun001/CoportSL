...
// The Worker occupies a running directory exclusively during its holding period; the operating system releases the lock when the process exits abnormally.
class RunLock {
public:
    RunLock() = default;
